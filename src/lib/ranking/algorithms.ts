...
export class PairwiseRanking implements RankingAlgorithm {
	...
	isComplete(cards: Card[], comparisons: Comparison[], _settings: RankingSettings): boolean {
	...
	getEstimatedComparisons(cardCount: number, _settings: RankingSettings): number {
